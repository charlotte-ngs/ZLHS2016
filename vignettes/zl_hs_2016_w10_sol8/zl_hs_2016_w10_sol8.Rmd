...
### Lösung
Angenommen, die Daten sind in einem Dataframe namens `dfMlrData` gespeichert. Dann wird das Regressionsmodell mit folgenden Anweisungen angepasst.

```{r LinRegModel, echo=TRUE, results='markup'}
lmMlrData <- lm(Leistung ~ Herde + Vater, data = dfMlrData)
summary(lmMlrData)
```
