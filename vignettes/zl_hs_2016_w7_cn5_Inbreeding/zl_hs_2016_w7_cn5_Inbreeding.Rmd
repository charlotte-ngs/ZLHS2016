...
Die Elemente $l_{ij}$ aus Matrix $L$ werden als Durchschnitt der Elemente $l_{sj}$ und $l_{dj}$ berechnet (siehe Kapitel __Inverse Verwandtschaftsmatrix__), wobei $s$ und $d$ die Eltern von $i$ sind.
