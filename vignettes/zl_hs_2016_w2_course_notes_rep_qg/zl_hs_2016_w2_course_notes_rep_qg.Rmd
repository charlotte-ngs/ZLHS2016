...
Aufgrund der Beziehungen zwischen Zuchtwerten, welche wir in den Gleichungen (\ref{eq:AdditiveBv1}) und (\ref{eq:AdditiveBv2}) gezeigt haben, werden Zuchtwerte als __additiv__ bezeichnet. Da der Term $2pq\alpha^2$ von den Zuchtwerten abhängt wird dieser auch als __genetisch additive__ Varianz $\sigma_A^2$ bezeichnet. Analog dazu bezeichnen wir den Term $\left(2pqd \right)$ als Dominanzvarianz $\sigma_D^2$. 
