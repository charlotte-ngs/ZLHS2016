...
Falls die Wirkung mehrerer Genorte auf ein Merkmal nicht der Summe der Wirkungen der einzelnen Genen entspricht, so spricht man von Interaktionen. Aufgrund der Interaktionen lässt sich die genetische Varianz $\sigma_G^2$ nicht mehr in additiv genetische Varianz und Dominanzvarianz zerlegen. Bei der Zerlegung kommt ein dritter Teil dazu, welcher als epistatische Varianz $\sigma_{I}^2$ bezeichnet wird.
...
Mit dem Term $\left(2pqd \right)^2$ wird analog der Summe der mit den Genotypenfrequenzen gewichteten quadrierten Dominanzabweichungen. Die entsprechende Ableitung ist nachfolgend gezeigt.
