...
wobei $cov(a,y) = cov(a,\mu + a + e) = cov(a,\mu) + cov(a,a) + cov(a,e)$. Aus den Annahmen zum Modell (\ref{eq:BasicModel}) wissen wir, dass $cov(a,\mu) = cov(a,e) = 0$. Die Covarianz der Zufallsvariablen mit sich selber entspricht der Varianz der Zufallsvariablen und somit ist $cov(a,a) = var(a)$. 
