...
<<VectorResiduals>>=
(vecRes <- round(residuals(lmRegModelSorte), digits = 2))
@
...
Die Maximum Likelihood Sch\"atzung der Restvarianz ist gleich, wie die Sch\"atzung aufgrund der Residuen bis auf den Faktor vor der Summe der quadrierten Residuen. Dieser lautet bei Maximum Likelihood $1/n$
