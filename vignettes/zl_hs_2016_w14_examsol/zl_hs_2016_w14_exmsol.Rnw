...
cat(paste(sGetTexMatrix(pmatAMatrix = matZtZIalpha, pnDigits = 0), collapse = "\n"))
cat("\\right]\n$$\n")
@
...
cat("$$X^Ty = \\left[\n")
cat(paste(sGetTexMatrix(pmatAMatrix = vecXtY, pnDigits = 2), collapse = "\n"))
cat("\\right]\n$$\n")
cat("$$Z^Ty = \\left[\n")
cat(paste(sGetTexMatrix(pmatAMatrix = vecZtY, pnDigits = 2), collapse = "\n"))
cat("\\right]\n$$\n")
@
...
cat("$$\\left[\n")
cat(paste(sGetTexMatrix(pmatAMatrix = matCoef, pnDigits = 2), collapse = "\n"))
cat("\\right]\n")
cat("\\left[\n")
cat(paste(sGetTexMatrix(pmatAMatrix = as.matrix(vecSol)), collapse = "\n"))
cat("\\right]\n")
cat(" = \\left[\n")
cat(paste(sGetTexMatrix(pmatAMatrix = as.matrix(vecRhs)), collapse = "\n"))
cat("\\right]\n$$\n")
@
